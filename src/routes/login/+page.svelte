...
>
	<div
		class=" w-[30rem] h-[26rem] border-[1px] border-ctp-text bg-ctp-base bg-opacity-60 backdrop-blur-xl flex flex-col items-center justify-between p-5 shadow-lg shadow-ctp-crust"
	>
		...
		>
			...
			<div>
				<button
					type="submit"
					class=" m-1 hover:text-ctp-subtext0 transition-colors duration-300 underline"
					>Submit</button
				>
			</div>
		</form>
