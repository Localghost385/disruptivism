<div
	class=" bg-ctp-surface0 border-t-[1px] border-ctp-text h-48 w-screen flex flex-col items-center justify-center p-4"
>
	...
	<div class="flex flex-row items-center gap-4 text-ctp-subtext0">
		...
		<span class="w-[1px] h-4 bg-ctp-subtext1"></span>
		<a href="/" class="hover:text-ctp-subtext0 transition-colors duration-300">placeholder</a>
		<span class="w-[1px] h-4 bg-ctp-subtext1"></span>
		<a href="/" class="hover:text-ctp-subtext0 transition-colors duration-300">placeholder</a>
		<span class="w-[1px] h-4 bg-ctp-subtext1"></span>
